...
### IsReadOnly
#### Type: `public bool`  
#### Required by: `IList<T>.ICollection<T>`  
#### Accessibility: `get`  
...
#### Type: `IEnumerator`  
#### Required by: `IList<T>.ICollection<T>.IEnumerable<T>`, `IList<T>.IEnumerable<T>`  
Summary:  
...
### WithCapacity()
#### Type: `public static OverallocatingArray<T>`  
#### Returns: `OverallocatingArray<T>`  
#### Type Arguments:  
